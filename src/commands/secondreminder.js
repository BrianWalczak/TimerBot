...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("secondreminder")
    .setDescription("Set a reminder for a desired time in seconds")
    ...
    run: async (client, interaction) => {
      interaction.reply(`**Your reminder for "${interaction.options.getString('reminder')}" has started. You will be notified once your timer ends.**`);
			...
			runTimer(interaction, Number(interaction.options.getNumber('seconds')), interaction.options.getString('reminder'))
    }
 };